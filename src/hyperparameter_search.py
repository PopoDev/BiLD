...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_config_name", type=str, default='', help="Dataset name.")
    ...
    for fb_threshold in args.fb_thresholds:
        for rb_threshold in args.rb_thresholds:
            if args.experiment == 'iwslt2017' or args.experiment == 'wmt2014':
                source_file_path = 'src/run_translation.py'
            else:
                source_file_path = 'src/run_summarization.py'
