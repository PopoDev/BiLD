...
case "$model" in
    aligned | unaligned)
        ...
        model_args="--model_name_large kssteven/T5-large-xsum --model_name_small $model_name_small --fallback_threshold $fallback_threshold --rollback_threshold $rollback_threshold"
        ;;
    vanilla)
